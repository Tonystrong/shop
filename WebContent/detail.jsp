        ...
        <div class="section_container">
                ...
                <div class="product_rightcol fr">
                    ...
                    <ul id="summary">
                        <li id="summary-market">
                            ...
                            <div class="dd"> <del id="page_maprice">￥21900.00</del>
                            </div>
                        </li>
                        <li id="summary-price">
                    ...
                    <div class="add_to_buttons">
                        <button class="add_cart"><a href="${shop}/sorderAction_addSorder.action?product.id=${product.id}">加入购物车</a></button>
                    </div>
                </div>
                <!--详情右侧结束--> </div>
            <!--产品详情结束-->
            ...
            <c:forEach items="${productList}" var="list">
	            <div class="products_list products_slider clear">
	                <h2 class="sub_title">${list[0].category.name}</h2>
	                <ul id="first-carousel" class="first-and-second-carousel jcarousel-skin-tango">
	                    <c:forEach items="${list}" var="product">
		                    <li> <a  href="${shop}/productAction_get.action?id=${product.id}"class="product_image"><img src="${shop }/upload/${product.pic}" /></a>
		                        <div class="product_info">
		                            <h3><a href="#">${product.name}</a></h3>
		                            <small>${product.remark}</small> </div>
		                        <div class="price_info"> 
		                            <button><span class="pr_add">添加购物车</span></button>
		                            <button class="price_add" title="" type="button"/><span class="pr_price">￥${product.price}</span>
		                        </div>
		                    </li>
		                 </c:forEach>  
	                </ul>
